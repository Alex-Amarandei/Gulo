...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-gray-700/50 focus:text-slate-100 focus:ring-0 focus:ring-transparent focus:border-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-gray-700/50 dark:focus:text-slate-100 dark:focus:ring-0 dark:focus:ring-transparent dark:focus:border-none cursor-pointer',
      inset && 'pl-8',
      className,
    )}
    {...props}
